...
def listarTarefas():
  ...
  requisicao = requests.get(f"http://192.168.15.20:5000/listarTarefasDiarias?usuario='{dicionario['usuario']}'")
...
def inserirTarefa():
  ...
  dicionario = {"usuario":'BiancaZL', "id_tarefa":id_tarefa, "tipo_tarefa":'Diária', "nome_tarefa":nome_tarefa}
...
def alterarTarefa():
  id_alteraTarefa = int(input('\nInsira o número de identificação da tarefa: '))
  nome_alteraTarefa = str(input('\nDigite o novo nome da tarefa: '))
  dicionario = {"usuario":'BiancaZL',"id_alteraTarefa":id_alteraTarefa, "nome_alteraTarefa":nome_alteraTarefa}
...
def concluirTarefa():
  id_concluiTarefa = int(input('\nInsira o número de identificação da tarefa para concluí-la: '))
  dicionario = {"usuario":'BiancaZL',"id_concluiTarefa":id_concluiTarefa}
...
def deletarTarefa():
  id_deletaTarefa = int(input('\nInsira o número de identificação da tarefa para deletá-la: '))
  dicionario = {"usuario":'BiancaZL',"id_deletaTarefa":id_deletaTarefa}
